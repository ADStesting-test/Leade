...
class Monitor:
    ...
    def coverage_monitor(self):
        ...
        fitness_vector = np.zeros(len(failure_statement_list))
        ...
        return coverage_rate, covered_statement_list, failure_statement_list, fitness_vector
...
if __name__ == "__main__":
    ...
    output_file = '/media/zhouyuan/MyBookPro/zhouyuan/ga_1/intersection2/results/297-result-2021-07-01-05-24-49.json'
